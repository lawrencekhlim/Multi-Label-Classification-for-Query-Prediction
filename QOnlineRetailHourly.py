...
class QOnlineRetail:
    ...
    def clean_data (self):
        ...
        uncleaned_training_data = self.data[int (24*360*self.training[0]):int(24*360*self.training[1])]
        ...
        with open ('hourlyTimeSeriesOnlineRetailCleaned.csv', "w") as csvfile:
    ...
    def train_data (self):
        ...
        print ("")
        print ("Window size " + str (self.data_size) + " Hours")
        print ("")
