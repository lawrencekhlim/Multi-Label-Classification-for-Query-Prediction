...
class GRUModel:
    ...
    def train (self, X, Y):
        ...
        print ("layer 1")
        self.model.add(L.GRU(self.input_output_size, return_sequences=True, input_shape=(self.window_size, self.input_output_size), activation='softmax'))  # returns a sequence of vectors of dimension self.input_output_size
        ...
        """
        self.model.add(L.GRU(self.input_output_size, return_sequences=True, activation='softmax'))  # returns a sequence of vectors of dimension self.input_output_size
        #self.model.add(L.LeakyReLU(alpha=.001))
        print ("layer 3")
        self.model.add(L.GRU(self.input_output_size, activation='softmax'))  # return a single vector of dimension self.input_output_size
